  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'premium-gold': 'var(--shadow-gold)',
        // Legacy support
        'pulse-sm': 'var(--shadow-sm)',
        'pulse-md': 'var(--shadow-md)',
        'pulse-lg': 'var(--shadow-lg)',
        'pulse-glow': 'var(--shadow-glow)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      backgroundImage: {
        ...
        'premium-gradient-subtle': 'var(--premium-gradient-subtle)',
      },
    },
  },
