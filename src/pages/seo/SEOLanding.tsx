...
const faqs = [
  ...
  { q: 'Mes messages sont-ils vraiment privés ?', a: 'Absolument. Chaque conversation est protégée par un chiffrement de bout en bout assuré par Libsignal avec PQXDH et Double Ratchet. Personne ne peut lire vos messages, pas même notre équipe.' },
