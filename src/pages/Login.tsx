...
import { prepareNormalSignIn } from '@/lib/authRecovery';
...
export default function Login() {
  ...
  // Merely reaching the normal login page means an abandoned password-reset
  // marker must not keep hijacking authentication.
  useEffect(() => {
    prepareNormalSignIn();
  }, []);
