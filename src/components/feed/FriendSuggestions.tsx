...
import { UserPlus, MapPin, Users, Clock } from 'lucide-react';
          ...
          <div className="flex gap-2.5 pb-1">
            {suggestions.map((s) => {
              ...
              return (
                <div
                  key={s.user_id}
                  className={`flex-shrink-0 w-[130px] rounded-xl border border-border/30 bg-secondary/20 p-3 flex flex-col items-center gap-2 text-center transition-opacity ${isSent ? 'opacity-50' : ''}`}
                >
