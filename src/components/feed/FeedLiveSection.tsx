          ...
          <div className="flex gap-2.5 pb-1">
            ...
            {hasLives && lives!.slice(0, 6).map((live) => (
              <Link
                key={live.id}
                to={`/live/${live.id}`}
                className="flex-shrink-0 w-[120px] rounded-xl overflow-hidden bg-black group relative aspect-[9/16]"
              >
                {live.thumbnail_url ? (
                  <img
                ...
                <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black/90 via-black/50 to-transparent z-10">
                  <div className="flex items-center gap-1.5 mb-1">
                    ...
                    <p className="text-white text-[10px] font-semibold truncate">{live.host?.name}</p>
                  </div>
                  <p className="text-white/80 text-[9px] truncate whitespace-normal line-clamp-2 leading-snug">{live.title}</p>
                </div>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black/90 via-black/50 to-transparent z-10">
                  <div className="flex items-center gap-1.5 mb-1">
                    ...
                    <p className="text-white text-[10px] font-semibold truncate">{replay.host?.name}</p>
                  </div>
                  <p className="text-white/80 text-[9px] truncate whitespace-normal line-clamp-2 leading-snug">{replay.title}</p>
                  {replay.ended_at && (
