...
export const PostCard = memo(function PostCard({ post, showActions = true, onCommentClick }: PostCardProps) {
  ...
  return (
    <article className="group relative bg-card border-y border-border/20 sm:border sm:border-border/20 sm:rounded-[26px] overflow-hidden transition-all duration-300 shadow-[0_10px_34px_-22px_hsl(var(--foreground)/0.2)] hover:shadow-[0_18px_44px_-24px_hsl(var(--foreground)/0.24)]">
      {/* Header */}
