...
export function LiveCard({ live, variant = 'card' }: LiveCardProps) {
  if (variant === 'compact') {
    return (
      <Link 
        to={`/live/${live.id}`}
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3">
        <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-red-500 text-white text-xs font-bold">
