      ...
      >
        ...
        <div className={cn('text-center', compact ? 'mb-3' : 'mb-5 sm:mb-6 px-2')}>
          ...
          <p className={cn('text-muted-foreground', compact ? 'text-[10px]' : 'text-xs sm:text-sm')}>
            {isLocked
              ? (compact ? 'Reconnectez-vous.' : 'Trop de tentatives. Reconnectez-vous pour réessayer.')
        ...
        {isLocked && (
          <motion.div
            ...
            className={cn(
              'bg-destructive/10 border border-destructive/15 w-full text-center mt-2',
          ...
          >
            ...
            <p className={cn('text-muted-foreground mt-0.5', compact ? 'text-[9px]' : 'text-xs')}>Reconnectez-vous pour réessayer.</p>
          </motion.div>
        )}
      </motion.div>
    </div>
