      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-[80px] right-5 z-[55] w-14 h-14 rounded-2xl flex items-center justify-center text-cyan-300 hover:text-cyan-100 active:scale-95 transition-all group md:bottom-[80px] md:right-8"
            style={{
