...
const SEARCH_ITEMS = [
  ...
  { label: 'Marketplace', path: '/marketplace', icon: ShoppingBag, keywords: ['market', 'shop', 'acheter', 'vendre', 'boutique'] },
  { label: 'Lives', path: '/live', icon: Radio, keywords: ['live', 'stream', 'direct', 'en direct'] },
  { label: 'Vidéos', path: '/videos', icon: Video, keywords: ['video', 'vidéos', 'reels', 'clips'] },
