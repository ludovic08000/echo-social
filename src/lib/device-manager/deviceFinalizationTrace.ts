...
function sanitizeDetail(detail: string | null | undefined): string | undefined {
  ...
  const allowed = new Set(['STILL_WAITING', 'ALREADY_READY', 'MESSAGING_READY', 'NO_NEXT_ACTION',
    ...
    'DEVICE_ID_READY', 'DEVICE_ID_PENDING', 'DEVICE_ID_FAILED', 'BACKED_UP',
    'MASTER_KEY_LOCKED', 'DEVICE_NOT_BOUND', 'LOCAL_DEVICE_KEYS_MISSING',
    'CLOUD_BACKUP_FAILED', 'LOCAL_VAULT_UNAVAILABLE']);
